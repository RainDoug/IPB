...
<p>We value the opportunity to learn how we can work for you. Call one of our experienced agents today at 321-752-5266 and let Hennessey Insurance Services demonstrate our dedication to delivering quality insurance policies that include comprehensive value and superior customer care.</p>
	...
	<?php /*
	<img src="images/homePhoto-2.jpg" style="float:left;margin:0 25px 25px 0;" />
	<p><? echo $businessName?> is an independent broker of insurance, securities, and employee benefits, working with our 
	clients to provide appropriate coverage in the most economical manner.</p>
	<p>In addition to individuals, the firm's clients include small businesses, financial institutions, churches, universities, 
	school districts, industrial firms, professional practices, and municipalities.</p>
	<p><? echo $businessName?> works with many different insurers in order to "shop the market" for its clients.  The companies 
	elected have the highest financial ratings. These companies are are among the oldest and largest in the United States and Canada.</p>
	<p>It is <? echo $businessName?>'s goal to protect business owners and individuals from unexpected losses, while helping them 
	create and conserve personal estates.  In many cases the business and personal objectives are inter-twined and must be carefully coordinated.  </p>
	<p>Through careful selection of insurance, securities and employee benefits, <? echo $businessName?> provides necessary 
	protection today and security for the future.</p>
	
	
	
	<p>We think that we're pretty special, but we can let our clients speak for themselves:</p>
	<div class="testimonials">
	</div>
	<p><img src="images/smallBadge_1.jpg" border="0" />
	<img src="images/smallBadge_2.jpg" border="0" /></p>
	<a href="http://www.trustedchoice.com/pledgeofperformance.htm"><img src="images/trusted_choice_pledge_page.jpg" border="0"/></a><br/>
	*/?>
</div>
